...
out_dir <- "~/Library/CloudStorage/Box-Box/SalivaryGlands_LL/Mouse_Transcriptome_SG/Figure_S9/mastersheets_ensembl/"
...
out_files <- setNames(file.path(out_dir, paste0(glands, "_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv")), glands)

# Orthology dictionary
orth_fp <- "~/Library/CloudStorage/Box-Box/SalivaryGlands_LL/Mouse_Transcriptome_SG/Figure_S9/orthologs_with_classification_ensembl.csv"
