...
Quick start
Put/update TPMs in: gene_expression_matrix_C57_CD1_TPMs.csv
...
Open mouse_proteome/function_add.csv.
Add (or edit) the row for your Geneid with Function (and optional Reference).
Re-run:
Rscript secretome_annotation_dictionary.R
Rscript annotate_each_gland_secreted_non_secreted_mouse.R
