...
PAR_h_path <- "mastersheets_ensembl/PAR_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv"
SM_h_path  <- "mastersheets_ensembl/SM_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv"
SL_h_path  <- "mastersheets_ensembl/SL_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv"

# Mouse (your mouse mastersheets)
PAR_m_path <- "mastersheets_ensembl/PAR_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv"
SM_m_path  <- "mastersheets_ensembl/SM_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv"
SL_m_path  <- "mastersheets_ensembl/SL_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv"
...
combined_pct_h
ggsave("figures/percent_total_expression_orthology_secreted_combined_horizontal_ensembl.png",
       combined_pct_h, width = 10, height = 6, dpi = 300)
ggsave("figures/percent_total_expression_orthology_secreted_combined_horizontal_ensembl.svg",
