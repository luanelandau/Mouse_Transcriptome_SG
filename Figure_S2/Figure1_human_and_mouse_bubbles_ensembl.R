...
setwd("~/Library/CloudStorage/Box-Box/SalivaryGlands_LL/Mouse_Transcriptome_SG/Figure_S9/")
...
mouse_files <- c(
  PAR = "mastersheets_ensembl/PAR_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv",
  SM  = "mastersheets_ensembl/SM_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv",
  SL  = "mastersheets_ensembl/SL_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv")
...
PAR = read.csv("mastersheets_ensembl/PAR_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv")
SM  = read.csv("mastersheets_ensembl/SM_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv")
SL  = read.csv("mastersheets_ensembl/SL_mastersheet_TPMs_annotated_for_secretion_and_orthology_ensembl.csv")
...
human_files <- c(
  PAR = "mastersheets_ensembl/PAR_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv",
  SM  = "mastersheets_ensembl/SM_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv",
  SL  = "mastersheets_ensembl/SL_human_mastersheet_TPMs_annotated_with_orthology_ensembl.csv"
)
...
## ---------- Save ----------
ggsave("figures/bubbles_mouse_top_human_bottom_3glands_ensembl.svg", combined, width = 14, height = 8)
ggsave("figures/bubbles_mouse_top_human_bottom_3glands_ensembl.png", combined, width = 14, height = 8, dpi = 300)

message("Done. Wrote: figures/bubbles_mouse_top_human_bottom_3glands_ensembl.(svg|png)")
